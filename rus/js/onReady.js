...
// Animation        
        ...
        if ( !$("html").hasClass("touch") ){
            ...
            if ( !$("body").hasClass("no-animate") ){
                ...
                $('.portfolio figure, .section2, .num-section, .advantages .icons .element, .content-section').addClass("hidden");
        ...
        $('.num1').viewportChecker({
            ...
            offset: 100,
            callbackFunction: function(){
                $('#num1').animateNumber({ number: 200 },2500);
            }
        });
        ...
        $('.num2').viewportChecker({
            ...
            offset: 100,
            callbackFunction: function(){
                $('#num2').animateNumber({ number: 500 },2500);
            }
        });
        ...
        $('.num3').viewportChecker({
            ...
            offset: 100,
            callbackFunction: function(){
                $('#num3').animateNumber({ number: 15 },1200);
            }
        });  
        ...
        $('.num4').viewportChecker({
            ...
            offset: 100,
            callbackFunction: function(){
                $('#num4').animateNumber({ number: 100 },2000);
            }
        });        
...
// End anchor menu        
        ...
        */
        ...
        $('.services-elements a.absolute').click(function(){
           var applicationValue = $(this).data('application'); 
           $('#applicationInput').val(applicationValue);
        });
