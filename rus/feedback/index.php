...
$from_email = 'noreply@elektriinsener.ee';
$from_name = 'elektriinsener.ee';
$to_email = 'Zagidullinvadimf@gmail.com';
...
$form['form-callback'] = array(
    ...
    'to_email' => $to_email,
		...
		'antispam' => '',
		'antispamjs' => '',
		'okay' => 'Заявка на обратный звонок успешно отправлена! Мы перезвоним вам в ближайшее время.'
	)
);
...
$form['form-feedback'] = array(
    ...
    'to_email' => $to_email,
		...
		'antispam' => '',
		'antispamjs' => '',
		'okay' => 'Сообщение успешно отправлено! Наш менеджер свяжется с вами в ближайшее время.'
	)
);

$form['form-application'] = array(
	'fields' => array(
        'service_name' => array(
    ...
    'to_email' => $to_email,
		...
		'antispam' => '',
		'antispamjs' => '',
		'okay' => 'Заявка успешно отправлена! Мы перезвоним вам в ближайшее время.'
	)
);
/********************** /. CONFIGURATION *************************/
